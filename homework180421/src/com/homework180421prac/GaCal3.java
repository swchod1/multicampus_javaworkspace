...
public class GaCal3 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == jb[2]) { // ←
			...
			case "√":
				...
				String temp3 = "sqrt(" + temp2 + ")";

				if (tf2.getText() == "0") {
					temp2 = "0 ";
				} else if(dtemp[0] == 0) {
					dtemp[0] =  Math.sqrt(Double.parseDouble(temp2));
					temp2 = String.valueOf(dtemp[0]) + " ";
				} else {
					dtemp[1] = Math.sqrt(Double.parseDouble(temp2));
					temp2 = String.valueOf(dtemp[1]) + " ";
				}
				
				temp1.replaceAll(temp2 + " √ ", temp3);
